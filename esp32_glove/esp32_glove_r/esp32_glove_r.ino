...
// Right hand: CMD 0-4 (thumb, index, middle, ring, pinky)
#define CMD_THUMB    '0'
#define CMD_INDEX    '1'
#define CMD_MIDDLE   '2'
#define CMD_RING     '3'
...
#define BLE_DEVICE_NAME "ESP32S3_GLOVE_R"
      ...
      if (rxValue.length() > 0) {
        ...
        for (int i = 0; i < rxValue.length(); i++) {
          ...
          switch (cmd) {
            ...
            default:
              // Ignore left-hand CMDs (5-9) and other unexpected chars
              break;
          }
        }
...
void setup() {
  ...
  Serial.println("ESP32-S3 RIGHT glove BLE UART Started. Waiting for connections...");
}
